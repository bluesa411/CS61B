...
public class NGramMap {
    ...
    public NGramMap(String wordsFilename, String countsFilename) {
        ...
        while (in.hasNextLine()) {
            ...
            if(ngrams.get(tokens[0]) != null) {
                ngrams.get(tokens[0]).put(Integer.parseInt(tokens[1]), Double.parseDouble(tokens[2]));
            } else{
                ngrams.put(tokens[0], new TimeSeries());
                ngrams.get(tokens[0]).put(Integer.parseInt(tokens[1]), Double.parseDouble(tokens[2]));
            }
        }
        in.close();
        ...
        while (in.hasNextLine()) {
            String Line = in.readLine();
            String[] tokens = Line.split(",");
            countsData.put(Integer.parseInt(tokens[0]), Double.parseDouble(tokens[1]));
        }
    }
