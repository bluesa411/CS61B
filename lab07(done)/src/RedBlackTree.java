public class RedBlackTree<T extends Comparable<T>> {
    ...
    RBTreeNode<T> rotateRight(RBTreeNode<T> node) {
        // TODO: YOUR CODE HERE
        //save the right tree of the new root
        RBTreeNode<T> temp = node.left.right;
        node.left.right = node;
        //switch the color between the new root and the old root
        boolean rootcolor = node.isBlack;
        node.isBlack = node.left.isBlack;
        node.left.isBlack = rootcolor;
